...
Seed
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c6 = function(left, right) { return left ? right ? Math.min(left, right) : left : right; },
        peg$c7 = "AND",
        ...
        peg$c14 = function(OrExpression) { return OrExpression; },
        peg$c15 = /^[A-Za-z0-9_]/,
        peg$c16 = { type: "class", value: "[A-Za-z0-9_]", description: "[A-Za-z0-9_]" },
        peg$c17 = function(chars) { return parserFindL1Prescale(chars.join("")); },
